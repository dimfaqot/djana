...
<div class="container p-2">
    ...
    <div class="d-sm-block d-md-none" style="margin-bottom:100px;">
        <div class="input-group input-group-sm p-2 fixed-top bg-light" style="top:50px;">
            ...
            <a class="btn btn-outline-secondary" href="<?= base_url(); ?>/produk" type="button"><i class="fa fa-trash"></i></a>
        </div>
    ...
    <?php if (session('role') !== 'User' && session('role') !== 'Guest') : ?>
        <a class="btn btn-sm btn-primary my-3" href="<?= base_url(); ?>/produk/add" role="button">Tambah Produk</a>
